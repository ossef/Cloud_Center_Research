...
//#define Lambda1 5.4 // p1 = 9/10 = 0.9 // p1 = 4/(10*0.45) = 0.9 // file 1 trop chargé
#define Lambda2 1 // p2 = 1/10 = 0.1 // p2 = 2/(10*2) = 0.1 //p2 = 5/(10*  1) = 0.5 // file 2 moyen chargé ( pas chargé)
//#define Mu1 0.6 // service1
...
double Probabilite(int indexevt, int *E, double gamma12, double Mu1)
{
    double p1, Delta;
    int nbServer, inservice;  
    int gamma21 = gamma12;
    double Lambda1 = 0.9*BufferSize*Mu1;
