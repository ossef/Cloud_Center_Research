...
void energie2(int tab[],double pi[],int taille, char ch[50],double gamma12, int alpha, double Mu1){ // Calcule Energie Nvelle formule en comptant le LB
	...
	FILE *f1=fopen(ch,"a");
		...
		fprintf(f1,"%lf %lf ",Mu1,s1+s2+s3+s4);
		fprintf(f1,"\n");
		fclose(f1);
}
