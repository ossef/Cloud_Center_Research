...
#define Lambda1 8.0 // p1 = 5/(10*0.55) = 0.9 // file 1 trop chargé
#define Lambda2 1.0 // p2 = 5/(10*5) = 0.1 //p2 = 5/(10*  1) = 0.5 // file 2 moyen chargé ( pas chargé)
...
double Probabilite(int indexevt, int *E, double gamma12)
{
    ...
    switch (indexevt) {
		...
		case 2:
			...
			break;
		case 3:
			if(E[1] == 0 && E[0] > 1 && gamma12>0 )
				p1 = ((E[0]-1)*Mu1)/Delta;
			else
				p1 = (E[0]*Mu1)/Delta;
			break;
		case 4:
			if(E[0] == 0 && E[1] > 1 && gamma21>0 ) 
				p1 = ((E[1]-1)*Mu2)/Delta;
			else
				p1 = (E[1]*Mu2)/Delta;
			break;
		...
		case 7:
			if(E[1] == 0 && E[0] > 1 && gamma12>0 )
				p1 =  ((BufferSize-E[0] +1)*Mu1 +(BufferSize-E[1])*Mu2) /Delta;
			else
				{
					if(E[0] == 0 && E[1] > 1 && gamma21>0)
						p1 =  ((BufferSize-E[0])*Mu1 +(BufferSize-E[1]+1)*Mu2) /Delta;
					else
